...
const featuredCollections = [
  {
    ...
    description: "Heirloom-inspired bridal jewelry for unforgettable vows.",
  },
  {
    title: "Limited Edition",
    description: "Exclusive drops with rare gemstone craftsmanship.",
  },
  {
    title: "Luxury Watches",
    description: "Swiss-inspired precision with a sculptural silhouette.",
  },
];
    ...
    <div className="pb-20">
      <section className="mx-auto grid max-w-7xl gap-8 px-4 py-10 lg:grid-cols-[1.15fr_0.85fr] lg:px-8 lg:py-16">
        <motion.div
          ...
          className="rounded-[2rem] bg-stone-900 p-10 text-white shadow-[0_40px_80px_rgba(39,25,16,0.2)] lg:p-14"
        >
          ...
          <h1 className="mt-4 text-4xl leading-tight sm:text-5xl lg:text-6xl">
            Fine jewelry designed for modern heirlooms.
          </h1>
          <p className="mt-6 max-w-xl text-lg text-stone-300">
            Discover signature rings, sculptural necklaces, and rare gemstones
            curated for everyday radiance and grand occasions.
          </p>
          <div className="mt-8 flex flex-wrap gap-4">
            <Link
              to="/jewelry"
              className="rounded-full bg-amber-500 px-6 py-3 font-medium text-stone-950 transition hover:bg-amber-400"
            >
              Shop Collection
            </Link>
            <Link
        ...
        <div className="flex items-end justify-between">
          <div>
            ...
            <h2 className="mt-2 text-3xl text-stone-800">
              Signature moments, beautifully framed.
            </h2>
          </div>
          <Link
            to="/jewelry"
            className="hidden text-sm font-semibold text-stone-700 hover:text-amber-700 md:block"
          >
            View All
          </Link>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 lg:px-8">
        <div className="flex items-end justify-between">
          <div>
            ...
            <h2 className="mt-2 text-3xl text-stone-800">
              Freshly crafted pieces for special occasions.
            </h2>
          </div>
          <Link
            to="/jewelry"
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {products
            ...
            .map((product) => (
              <div
                key={product.id}
                className="overflow-hidden rounded-[1.5rem] border border-stone-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl"
              >
                <img
                  src={product.image}
                  alt={product.name}
                ...
                <div className="p-6">
                  ...
                  <h3 className="mt-3 text-xl text-stone-800">
                    {product.name}
                  </h3>
        ...
        <div className="rounded-[2rem] border border-stone-200 bg-white p-8 shadow-sm lg:p-10">
          <div className="grid gap-6 lg:grid-cols-[1fr_0.7fr]">
            <div>
              ...
              <h2 className="mt-2 text-3xl text-stone-800">
                Trusted craftsmanship, ethically sourced gemstones, and timeless
                design.
              </h2>
                ...
                {[
                  {
                    ...
                    text: "Verified purity with official hallmarking.",
                  },
                  {
                    icon: Gem,
                    title: "Conflict-Free Diamonds",
                    text: "Ethically sourced stones and transparent provenance.",
                  },
                  {
                    icon: ShieldCheck,
                    title: "Secure Checkout",
                    text: "Protected payments and insured delivery.",
                  },
                  {
                    icon: Truck,
                    title: "Free Shipping",
                    text: "Complimentary express delivery on luxury pieces.",
                  },
                ].map((item) => {
            ...
            <div className="overflow-hidden rounded-[1.5rem]">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKEzMIBp78YftiV0wmIDYv8KkYVKSYKbpUqgaNOYby1TwQzApAoBpqEo4&s=10"
                alt="Luxury jewelry closeup"
