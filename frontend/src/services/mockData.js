...
export const products = Array.from({ length: 100 }, (_, index) => {
  ...
  return {
    ...
    description:
      "Crafted in our atelier with certified stones, refined detailing, and exceptional brilliance.",
    price,
    discount,
    stock,
...
export const orders = [
  {
    ...
    status: "Delivered",
    paymentStatus: "Paid",
    items: [products[0], products[2]].map((product) => ({
      ...product,
      quantity: 1,
    })),
  },
  {
    ...
    status: "Shipped",
    paymentStatus: "Paid",
    items: [products[3], products[4]].map((product) => ({
      ...product,
      quantity: 1,
    })),
  },
